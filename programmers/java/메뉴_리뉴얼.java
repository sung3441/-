...
class Solution {
    ...
    public List<String> getBestCourseList(String[] orders, int courseCount) {
        ...
        for (String bestCourseCandidate : courseMap.keySet()) {
            Integer orderCount = courseMap.get(bestCourseCandidate);
            if (orderCount == maxOrderCount) {
                bestCourseList.add(bestCourseCandidate);
            }
        }
        return bestCourseList;
    }
